...
import lda.location.adaptor.PositionAdaptor;
 ...
 */
public class PositionDeliverer {
     
    static Logger LOG = Logger.getLogger(PositionDeliverer.class);

    public static void deliverPositions(){
        
        try{
            PositionAdaptor adaptor = PositionAdaptorFactory.getPositionProvider(LDAConfigProviderFactory.getCurrentConfigProvider());
