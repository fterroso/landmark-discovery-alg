...
class DirEntry implements Serializable
{
    ...
    double bounces[];                    // the mbr of the box
    ...
    */
    boolean section_circle(Location center, float radius)
    {
    ...
    */
    boolean section_ring(Location center, float radius1, float radius2)
    {
