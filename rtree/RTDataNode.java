...
public final class RTDataNode extends RTNode implements Node
{
    ...
    public void overlapping(double p[], int nodes_t[])
    { nodes_t[0]++; }
    ...
    public RTDataNode(RTree rt, int _block)
    {
        ...
        System.out.println("Crea data node");
        byte b[];
        int header_size;
        Data d;
    ...
    */
    ...
    // werden
    {
        ...
        double mbr_array[][]; // to be passed as parameter to RTNode.split()
    ...
    //#endif
        ...
        mbr_array = new double[n][2*dimension];
        for (i = 0; i < n; i++)
        {
    ...
    */
    ...
    public void point_query(double p[])
    {
        int i, n,j;
        double dmbr[];
    ...
    public void point_query(Location p, SortedLinList res)
    {
        int i, n,j;
        double dmbr[];
    ...
    public void rangeQuery(double mbr[], SortedLinList res)
    {
        int i, n,j;
        double dmbr[];
        Data rect;
    ...
    public void ringQuery(Location center, float radius1, float radius2, SortedLinList res)
    {
        int i, n,j,k;
        double dmbr[];
    ...
    @Override
    public void rangeQuery(Location center, float radius, SortedLinList res)
    {
        int i, n,j,k;
        double dmbr[];
...
//            if (Constants.section_c(dimension, dmbr, center,radius))
            if (Constants.geo_section_c(dimension, dmbr, center,radius))
            {
...
//                Nearest.distanz = distanz;
    ...
    public void NearestNeighborSearch(Location QueryPoint,
                SortedLinList res,
    ...
    {
        int i,j,n;
        double nearest_dist,distanz,dmbr[];
        Location point;
