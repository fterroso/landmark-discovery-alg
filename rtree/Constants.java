...
/* These values are now set by the users - see UserInterface module.*/
    ...
    // for comparisons
    public final static double min(double a, double b) {return (a < b)? a : b;}
    ...
    public final static double max(double a, double b) {return (a > b)? a : b;}
    ...
    public final static long MAX_POINT_LIFETIME = 1296000000; // in milliseconds (2 weeks)
    ...
    public static float area(int dimension, double mbr[])
    {
        int i;
        float sum;
    ...
    // to the axes
    public static float margin(int dimension, double mbr[])
    {
        int i;
        int ml, mu, m_last;
        float sum;
    ...
    public static boolean inside(double p, double lb, double ub)
    {
        return (p >= lb && p <= ub);
    }

    // ist ein Vektor in einer Box ?
    public static boolean inside(double v[], double mbr[], int dimension)
    {
        int i;
    ...
    public static float overlap(int dimension, double r1[], double r2[])
    {
        float sum;
    ...
    public static void enlarge(int dimension, double mbr[], double r1[], double r2[])
    {
        int i;
    ...
    */
    public static boolean section(int dimension, double mbr1[], double mbr2[])
    {
        int i;
    ...
    */
    public static boolean section_c(int dimension, double mbr1[], Object center, float radius)
    {
        float r2;
    ...
    public static boolean geo_section_c(int dimension, double mbr1[], Object center, float radius)
    {
        return MINGEODIST(center, mbr1) <= radius;
    }
    
    /**
    * returns true if the specified mbr intersects the specified circle
    */
    public static boolean section_ring(int dimension, double mbr1[], Object center, float radius1, float radius2)
    {
    ...
    */
    public static float objectDIST(Location point1, Location point2)
    {
    ...
    */
    public static double MINDIST(Object pt, double bounces[])
    {
        //
    ...
    public static float MINGEODIST(Object pt, double bounces[])
    {
        Location point = (Location)pt;
        ...
        return DIST(point, result);
    }
    
    public static float DIST(Location p1, Location p2){
        
        switch(LDAConfigProviderFactory.getCurrentConfigProvider().getSpaceType()){
            case cartesian:
                double x = Math.pow(p1.data[0]-p2.data[0],2);
                double y = Math.pow(p1.data[1]-p2.data[1],2);

                double result = Math.sqrt(x+y);

                return (float) result;
            default:
                float lat1 = (float) p1.data[0];
                float lat2 = (float) p2.data[0];
                float lng1 = (float) p1.data[1];
                float lng2 = (float) p2.data[1];
        ...
        //        System.out.println(p1 + " [" + p2.data[1] + ", " + p2.data[0] + "] " + dist);
    ...
    * point
    */
    public static float MAXDIST(Object pt, double bounces[])
    {
        Location point = (Location)pt;
    ...
    */
    public static float MINMAXDIST(Location point, double bounces[])
    {
    ...
    public static int pruneBranchList(double nearest_distanz/*[]*/, Object activebranchList[], int n)
    {
    ...
    public static rectangle toRectangle (double rect[])
    {
