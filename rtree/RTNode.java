...
public class RTNode implements Serializable
{
    ...
    */
    public int split(double mbr[][], int distribution[][])
    {
    //#ifdef SHOWMBR
    //    split_000++;
    //#endif
        ...
        double minmarg;            // the minimum margin (used to compute best split axis)
        double marg, minover, mindead, dead, over, rxmbr[], rymbr[];
