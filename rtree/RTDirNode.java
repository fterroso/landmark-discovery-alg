...
public final class RTDirNode extends RTNode implements Node
{
    ...
    */
    ...
    // werden
    {
        ...
        double mbr_array[][];                     // array of the mbrs of all entries
    ...
    //#endif
        ...
        mbr_array = new double[n][dimension*2];
        for (i = 0; i < n; i++)
    ...
    */
    public int choose_subtree(double mbr[])
    {
        int i, j, n, follow, minindex=0, inside[], inside_count, over[];
        double bmbr[] = new double[2*dimension];
    ...
    */
    public void rangeQuery(Location center, float radius,
            SortedLinList res)
    {
        int i, n;
        boolean s;
    ...
    */
    public void NearestNeighborSearch(Location QueryPoint, Location Nearest, float/*[]*/ nearest_distanz)
    {
