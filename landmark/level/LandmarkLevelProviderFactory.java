 ...
 */
public class LandmarkLevelProviderFactory {
    
    public static LandmarkLevelProvider getLandmarkLevelProvider(LDAConfigProvider config){
        
        return new BasicLandmarkLevelProvider();
    }
